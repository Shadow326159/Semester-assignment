...
//----------------------------------------------------------------------------------
void ReadImageFromFile(char* FileName, unsigned char* B, unsigned char* G, unsigned char* R)
{
	FILE *file = fopen(FileName,"rb");
...
//----------------------------------------------------------------------------
void WriteImage(char* FileName, unsigned char* B, unsigned char* G, unsigned char* R)
{
